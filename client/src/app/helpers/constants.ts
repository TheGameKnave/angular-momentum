...
export const INSTALLERS: Record<'name' | 'icon' | 'url', string>[] = [
  ...
  },
  {
    name: 'Windows',
    icon: 'pi-microsoft',
    url: 'https://github.com/TheGameKnave/angular-momentum/releases/latest/download/Angular_Momentum_{version}_x64_en-US_windows.msi',
  },
  {
    name: 'Mac',
    icon: 'pi-apple',
    url: 'https://github.com/TheGameKnave/angular-momentum/releases/latest/download/Angular_Momentum_{version}_x64_darwin.dmg',
  },
  {
    name: 'Linux',
    icon: 'pi-desktop',
    url: 'https://github.com/TheGameKnave/angular-momentum/releases/latest/download/Angular_Momentum_{version}_amd64_linux.AppImage',
  },
];
